...
- 📱 Développeur spécialisé dans la création d'applications mobiles **Flutter (iOS & Android)**  
...
- Création de **MVP rapides (≈45 jours)**
- Applications mobiles **prêtes à évoluer**
- Publication sur **App Store & Google Play**
- Architecture technique et backend (**Firebase**)

---

<h3 align="left">Applications créées</h3>

📱 **Wake Up Alarme**  
Application d’alarme mobile conçue pour améliorer les routines de réveil.

📱 **Plouff Habitudes**  
Application de suivi d’habitudes permettant de créer et maintenir des routines positives.
